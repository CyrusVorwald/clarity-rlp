(define-read-only  (encodeDeposit )
    (begin
       (ok (encode-arr (list
          ...
          (encode-string "0x0000000000000000000000000000000000000003")
          (encode-string "0x0000000000000000000000000000000000001234")
          (encode-string "0x1.icon/cx5")
          (encode-uint u112356000000000000000000)
          (encode-buff 0x73776170)
          (encode-arr (list
            (encode-string "0x0000000000000000000000000000000000000003")
            (encode-string "0x0000000000000000000000000000000000001234")
         ))
